...
type Props = {
  /** The call's title, already resolved by `useActiveCycle`. Empty while loading. */
  title: string
}
 ...
 */
export default function RegistrationLede({ title }: Props) {
  return (
    <>
      <p className="eyebrow">{m.reg_eyebrow({ title })}</p>

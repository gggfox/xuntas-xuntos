...
export default function SignUpScreen() {
  ...
  // sessionStorage does not exist on the server; it is read after hydrating.
  ...
  if (token === undefined) {
    return <main className="mx-auto max-w-[560px] px-[22px] py-16 text-soft">{m.common_loading()}</main>
  }
    ...
    <main className="mx-auto max-w-[560px] px-[22px] pt-[46px] pb-[90px]">
      ...
      <div className="mt-8">
        <SignUp
          ...
          // URL, which carries the locale prefix. Without `path` nothing mounts.
          routing="path"
